...
[[vk::binding(0, 0)]] RWStructuredBuffer<ChainState> chains;
[[vk::binding(1, 0)]] RWStructuredBuffer<float> samples;
[[vk::binding(2, 0)]] RWStructuredBuffer<float> obs_data;
...
[[vk::push_constant]] cbuffer PC { Params params; };
...
int main()
{
    try
    {
        ...
        desc.bindings = {buf_chains.descriptorInfo(), buf_samples.descriptorInfo(),
                         buf_data.descriptorInfo()};
        desc.pushConstantSize = sizeof(pc);

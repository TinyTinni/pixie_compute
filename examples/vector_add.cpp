...
int main()
{
    try
    {
        ...
        pipelineDesc.slangSource = shader;
        pipelineDesc.bindings = {
            buf_a.descriptorInfo(), buf_b.descriptorInfo(), buf_c.descriptorInfo()};
        ...
        std::printf("[vector_add] N=%u  max error: %.6e  %s\n", N, maxErr,

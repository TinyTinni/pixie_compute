...
TEST_CASE("GpuImage VMA-backed construction", "[image]")
{
    ...
    GpuImage img(ctx, GpuImageDesc{64, 64, 1, vk::Format::eR8G8B8A8Unorm,
...
TEST_CASE("GpuImage construction with extra parameters", "[image]")
{
    ...
    GpuImage img(ctx, GpuImageDesc{32, 32, 1, vk::Format::eR8G8B8A8Unorm,
                                   vk::ImageUsageFlagBits::eStorage, vk::ImageType::e2D, 4, 6});
...
TEST_CASE("GpuImage descriptorInfo", "[image]")
{
    ...
    GpuImage img(ctx, GpuImageDesc{32, 16, 1, vk::Format::eR32Sfloat,
                                   vk::ImageUsageFlagBits::eStorage});
...
TEST_CASE("GpuImage move semantics", "[image]")
{
    ...
    GpuImage img(ctx, GpuImageDesc{48, 48, 1, vk::Format::eB8G8R8A8Unorm,
                                   vk::ImageUsageFlagBits::eStorage});
...
TEST_CASE("GpuImage different formats", "[image]")
{
    ...
    GpuImage imgFloat(ctx, GpuImageDesc{16, 16, 1, vk::Format::eR32G32B32A32Sfloat,
                                        vk::ImageUsageFlagBits::eStorage});
    REQUIRE(imgFloat.format() == vk::Format::eR32G32B32A32Sfloat);

    GpuImage imgUint(ctx, GpuImageDesc{16, 16, 1, vk::Format::eR8Uint,
                                       vk::ImageUsageFlagBits::eStorage});
...
TEST_CASE("GpuImage move assignment", "[image]")
{
    ...
    GpuImage a(ctx, GpuImageDesc{16, 16, 1, vk::Format::eR8G8B8A8Unorm,
                                 vk::ImageUsageFlagBits::eStorage});
    GpuImage b(ctx, GpuImageDesc{32, 32, 1, vk::Format::eR8G8B8A8Unorm,
                                 vk::ImageUsageFlagBits::eStorage});
...
TEST_CASE("GpuImage upload readback via compute shader", "[image]")
{
    ...
    GpuImage img(ctx,
                 GpuImageDesc{W, H, 1, vk::Format::eR32Sfloat,
    ...
    pipelineDesc.spirv = readbackSpirv;
    pipelineDesc.bindings = {GpuBinding(outBuf.descriptorInfo()),
                             GpuBinding(img.descriptorInfo(vk::ImageLayout::eGeneral),
                                        vk::DescriptorType::eStorageImage)};
    pipelineDesc.groupsX = W;
    pipelineDesc.groupsY = H;
...
{
    auto &ctx = GpuTestFixture::ctx();
    GpuImage img(ctx, GpuImageDesc{16, 16, 1, vk::Format::eR32Sfloat,
                                   vk::ImageUsageFlagBits::eSampled |
...
{
    auto &ctx = GpuTestFixture::ctx();
    GpuImage img(ctx, GpuImageDesc{64, 1, 1, vk::Format::eR32Sfloat,
                                   vk::ImageUsageFlagBits::eStorage, vk::ImageType::e1D});
...
TEST_CASE("GpuImage imageBarrier with explicit aspect mask", "[image][cmd]")
{
    ...
    GpuImage img(ctx, GpuImageDesc{64, 64, 1, vk::Format::eR32Sfloat,
                                   vk::ImageUsageFlagBits::eStorage});

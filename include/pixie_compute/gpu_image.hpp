...
class GpuImage
{
    ...
    [[deprecated("use GpuImageDesc")]]
    GpuImage(GpuContext &ctx, uint32_t width, uint32_t height, vk::Format format,
             vk::ImageUsageFlags usage, vk::ImageType imageType = vk::ImageType::e2D,
             uint32_t mipLevels = 1, uint32_t arrayLayers = 1, vk::ImageCreateFlags flags = {},
             vk::ImageTiling tiling = vk::ImageTiling::eOptimal);
